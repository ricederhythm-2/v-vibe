...
export const PLATFORMS: Platform[] = [
  ...
  { id: '17live',      label: '17LIVE',     color: '#1B74E4', bg: '#1B74E41A', placeholder: 'https://17.live/profile/...' },
  { id: 'iriam',       label: 'IRIAM',      color: '#E8553E', bg: '#E8553E1A', placeholder: 'https://www.iriam.com/streamer/...' },
